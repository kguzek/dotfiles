...
- Released `agent-slack` `v0.4.3` (latest as of 2026-02-25) does not include `channel list`.
- For read-only/channel discovery workflows on `v0.4.3`, prefer `message list`, `search`, and `user list`.
